...
set output_dir = /home/medicaldata3/LJData/rbCue.choose.result/$subj
...
3dDeconvolve -input $glm1_rpath/pb04.$subj.r*.scale+tlrc.HEAD                            \
    ...
    -stim_times_AM2 3 stimuli/rbcue.choose.times.choose.txt 'BLOCK(2,1)'                \
    -stim_label 3 times.choose                                                   \
    -stim_times_AM2 4 stimuli/rbcue.unchoose.times.unchoose.txt 'BLOCK(2,1)'           \
