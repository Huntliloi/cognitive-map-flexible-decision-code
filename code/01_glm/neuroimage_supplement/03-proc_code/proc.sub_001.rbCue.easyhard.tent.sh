...
set output_dir = /home/medicaldata3/LJData/rbCue.easyhard.tent.result/$subj
...
cp /home/image030/analysis_code/stimulus_glm/rbCue.glm/rbcue.times.blueCue.txt  \
    ...
    /home/image030/analysis_code/stimulus_glm/rbCue.glm/rbcue.F1.times.easy.txt   \
    /home/image030/analysis_code/stimulus_glm/rbCue.glm/rbcue.F1.times.hard.txt \
    /home/image030/analysis_code/stimulus_glm/rbCue.glm/rbcue.F2.times.easy.txt   \
    /home/image030/analysis_code/stimulus_glm/rbCue.glm/rbcue.F2.times.hard.txt \
    $output_dir/stimuli
    
# ------------------------------
# run the regression analysis
3dDeconvolve -GOFORIT 12 \
    -input $glm1_rpath/pb04.$subj.r*.scale+tlrc.HEAD                            \
    ...
    -stim_times_AM2 3 stimuli/rbcue.F1.times.easy.txt 'TENT(-2,16,10)'           \
    -stim_label 3 times.F1.easy                                               \
    -stim_times_AM2 4 stimuli/rbcue.F1.times.hard.txt 'TENT(-2,16,10)'           \
    -stim_label 4 times.F1.hard                                              \
    -stim_times_AM2 5 stimuli/rbcue.F2.times.easy.txt 'TENT(-2,16,10)'            \
    -stim_label 5 times.F2.easy                                              \
    -stim_times_AM2 6 stimuli/rbcue.F2.times.hard.txt 'TENT(-2,16,10)'          \
    -stim_label 6 times.F2.hard                                              \
    -jobs 8                                                                  \
