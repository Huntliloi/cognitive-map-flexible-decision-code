...
echo "auto-generated by afni_proc.py, Tue Dec  6 08:56:33 2022"
...
set output_dir = /home/medicaldata/LJData/SR_ana/analysis_res/glm_raw/face.glm.result/$subj
...
cp /home/image030/analysis_code/stimulus_glm/face/face.glm.times.1.txt  \
    /home/image030/analysis_code/stimulus_glm/face/face.glm.times.2.txt \
    /home/image030/analysis_code/stimulus_glm/face/face.glm.times.3.txt \
    $output_dir/stimuli
...
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat \
    /home/image030/fMRI_data/$subj/func_1/face_run1_SENSE.nii.gz'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r02.tcat \
    /home/image030/fMRI_data/$subj/func_1/face_run2_SENSE.nii.gz'[0..$]'

# and make note of repetitions (TRs) per run
set tr_counts = ( 151 151 )
...
3dDeconvolve -input pb04.$subj.r*.scale+tlrc.HEAD                        \
    ...
    -polort 3 -float                                                     \
    -num_stimts 3                                                        \
    -stim_times 1 stimuli/face.glm.times.1.txt 'BLOCK(16,1)'             \
    -stim_label 1 face                                                      \
    -stim_times 2 stimuli/face.glm.times.2.txt 'BLOCK(16,1)'             \
    -stim_label 2 object                                                      \
    -stim_times 3 stimuli/face.glm.times.3.txt 'BLOCK(16,1)'             \
    -stim_label 3 scram                                                      \
    -gltsym 'SYM: face -object'                                          \
    -glt_label 1 face-object                                             \
    -gltsym 'SYM: face -scram'                                           \
    -glt_label 2 face-scram                                              \
    -gltsym 'SYM: object -scram'                                         \
...
1dcat X.nocensor.xmat.1D'[8]' > ideal_face.1D
1dcat X.nocensor.xmat.1D'[9]' > ideal_object.1D
1dcat X.nocensor.xmat.1D'[10]' > ideal_scram.1D
...
#     /home/image030/fMRI_data/$subj/func_1/face_run1_SENSE.nii.gz              \
#     /home/image030/fMRI_data/$subj/func_1/face_run2_SENSE.nii.gz              \
#     -tcat_remove_first_trs 0 -tlrc_base MNI_avg152T1+tlrc -volreg_align_to  \
#     MIN_OUTLIER -volreg_align_e2a -volreg_tlrc_warp -blur_size 8.0          \
#     -regress_stim_times                                                     \
#     /home/image030/analysis_code/stimulus_glm/face.glm.times.1.txt          \
#     /home/image030/analysis_code/stimulus_glm/face.glm.times.2.txt          \
#     /home/image030/analysis_code/stimulus_glm/face.glm.times.3.txt          \
#     -regress_stim_labels 1 2 3 -regress_basis 'BLOCK(16,1)'                 \
