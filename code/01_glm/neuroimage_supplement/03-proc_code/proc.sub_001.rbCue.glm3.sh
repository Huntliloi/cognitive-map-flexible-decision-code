...
set glm1_rpath = /home/medicaldata/LJData/SR_ana/analysis_res/glm/rbCue.glm1.result/${subj}
...
# set output_dir = /home/image030/analysis_res/rbCue.glm3.result/$subj
set output_dir = /home/medicaldata/LJData/SR_ana/analysis_res/glm/rbCue.glm3.result/$subj
...
cp /home/image030/analysis_code/stimulus_glm/rbcue.times.blueCue.txt  \
    /home/image030/analysis_code/stimulus_glm/rbcue.times.redCue.txt  \
    /home/image030/analysis_code/stimulus_glm/rbcue.times.F1.txt      \
    /home/image030/analysis_code/stimulus_glm/rbcue.GLM3.times.F2.txt \
    $output_dir/stimuli
...
3dDeconvolve -input $glm1_rpath/pb04.$subj.r*.scale+tlrc.HEAD                            \
    ...
    -stim_times_AM2 3 stimuli/rbcue.times.F1.txt 'BLOCK(2,1)'                \
    -stim_label 3 times.F1                                                   \
    -stim_times_AM2 4 stimuli/rbcue.GLM3.times.F2.txt 'BLOCK(2,1)'           \
    -stim_label 4 GLM3.times.F2                                              \
    -jobs 8                                                                  \
