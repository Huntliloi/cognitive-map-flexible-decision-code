...
echo "auto-generated by afni_proc.py, Wed Nov  9 16:07:03 2022"
...
set output_dir = /home/medicaldata/LJData/SR_ana/analysis_res/wCue.rsa.result/$subj
...
cp /home/image030/analysis_code/stimulus_rsa/wcue.times.Cue_blank.txt \
...
3dDeconvolve -input pb03.$subj.r*.scale+tlrc.HEAD                        \
    ...
    -polort 3 -float                                                     \
    -num_stimts 15                                                       \
    -stim_times 1 stimuli/wcue.times.Cue_blank.txt 'GAM'                 \
    -stim_label 1 Cue_blank                                              \
    -stim_times 2 stimuli/wcue.times.Face_10.txt 'BLOCK(2,1)'            \
    -stim_label 2 Face_10                                                \
    -stim_times 3 stimuli/wcue.times.Face_11.txt 'BLOCK(2,1)'            \
    -stim_label 3 Face_11                                                \
    -stim_times 4 stimuli/wcue.times.Face_12.txt 'BLOCK(2,1)'            \
    -stim_label 4 Face_12                                                \
    -stim_times 5 stimuli/wcue.times.Face_13.txt 'BLOCK(2,1)'            \
    -stim_label 5 Face_13                                                \
    -stim_times 6 stimuli/wcue.times.Face_14.txt 'BLOCK(2,1)'            \
    -stim_label 6 Face_14                                                \
    -stim_times 7 stimuli/wcue.times.Face_15.txt 'BLOCK(2,1)'            \
    -stim_label 7 Face_15                                                \
    -stim_times 8 stimuli/wcue.times.Face_2.txt 'BLOCK(2,1)'             \
    -stim_label 8 Face_2                                                 \
    -stim_times 9 stimuli/wcue.times.Face_3.txt 'BLOCK(2,1)'             \
    -stim_label 9 Face_3                                                 \
    -stim_times 10 stimuli/wcue.times.Face_4.txt 'BLOCK(2,1)'            \
    -stim_label 10 Face_4                                                \
    -stim_times 11 stimuli/wcue.times.Face_5.txt 'BLOCK(2,1)'            \
    -stim_label 11 Face_5                                                \
    -stim_times 12 stimuli/wcue.times.Face_6.txt 'BLOCK(2,1)'            \
    -stim_label 12 Face_6                                                \
    -stim_times 13 stimuli/wcue.times.Face_7.txt 'BLOCK(2,1)'            \
    -stim_label 13 Face_7                                                \
    -stim_times 14 stimuli/wcue.times.Face_8.txt 'BLOCK(2,1)'            \
    -stim_label 14 Face_8                                                \
    -stim_times 15 stimuli/wcue.times.Face_9.txt 'BLOCK(2,1)'            \
    -stim_label 15 Face_9                                                \
    -jobs 8                                                              \
...
1dcat X.nocensor.xmat.1D'[12]' > ideal_Cue_blank.1D
1dcat X.nocensor.xmat.1D'[13]' > ideal_Face_10.1D
1dcat X.nocensor.xmat.1D'[14]' > ideal_Face_11.1D
1dcat X.nocensor.xmat.1D'[15]' > ideal_Face_12.1D
1dcat X.nocensor.xmat.1D'[16]' > ideal_Face_13.1D
1dcat X.nocensor.xmat.1D'[17]' > ideal_Face_14.1D
1dcat X.nocensor.xmat.1D'[18]' > ideal_Face_15.1D
1dcat X.nocensor.xmat.1D'[19]' > ideal_Face_2.1D
1dcat X.nocensor.xmat.1D'[20]' > ideal_Face_3.1D
1dcat X.nocensor.xmat.1D'[21]' > ideal_Face_4.1D
1dcat X.nocensor.xmat.1D'[22]' > ideal_Face_5.1D
1dcat X.nocensor.xmat.1D'[23]' > ideal_Face_6.1D
1dcat X.nocensor.xmat.1D'[24]' > ideal_Face_7.1D
1dcat X.nocensor.xmat.1D'[25]' > ideal_Face_8.1D
1dcat X.nocensor.xmat.1D'[26]' > ideal_Face_9.1D
...
rm pb*tcat+orig* *tshift+orig* *volreg+tlrc* T1W_3D_MPRAGE_1mm_SENSE+orig.* T1W_3D_MPRAGE_1mm_SENSE_al_junk+orig.* pre.T1W_3D_MPRAGE_1mm_SENSE_ns+orig.* all_runs.*+tlrc.* errts.*+tlrc.*
