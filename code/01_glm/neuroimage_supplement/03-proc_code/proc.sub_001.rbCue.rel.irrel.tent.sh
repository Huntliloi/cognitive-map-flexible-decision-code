...
set output_dir = /home/medicaldata/LJData/SR_ana/analysis_res/rbCue.relirrel.result/$subj
...
cp /home/image030/analysis_code/stimulus_glm/rbCue.glm/rbcue.times.blueCue.txt  \
    ...
    /home/image030/analysis_code/stimulus_glm/rbCue.glm/rbcue.GLM1.times.F2.txt \
    $output_dir/stimuli
...
3dDeconvolve -input $glm1_rpath/pb04.$subj.r*.scale+tlrc.HEAD                            \
    ...
    -stim_times_AM2 3 stimuli/rbcue.times.F1.txt 'TENT(-2,16,10)'                \
    -stim_label 3 times.F1                                                   \
    -stim_times_AM2 4 stimuli/rbcue.GLM1.times.F2.txt 'TENT(-2,16,10)'           \
