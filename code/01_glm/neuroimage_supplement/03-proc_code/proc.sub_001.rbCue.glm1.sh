...
echo "auto-generated by afni_proc.py, Fri Nov  4 09:31:12 2022"
...
# set output_dir = /home/image030/analysis_res/rbCue.glm1.result/$subj
set output_dir = /home/medicaldata/LJData/SR_ana/analysis_res/rbCue.glm1.result/$subj
...
cp /home/image030/analysis_code/stimulus_glm/rbcue.times.blueCue.txt  \
    ...
    /home/image030/analysis_code/stimulus_glm/rbcue.GLM1.times.F2.txt \
    $output_dir/stimuli
...
3dTcat -prefix $output_dir/pb00.$subj.r01.tcat \
    /home/image030/fMRI_data/$subj/func_2/SR4_run1_SENSE.nii.gz'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r02.tcat \
    /home/image030/fMRI_data/$subj/func_2/SR4_run2_SENSE.nii.gz'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r03.tcat \
    /home/image030/fMRI_data/$subj/func_2/SR4_run3_SENSE.nii.gz'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r04.tcat \
    /home/image030/fMRI_data/$subj/func_2/SR4_run4_SENSE.nii.gz'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r05.tcat \
    /home/image030/fMRI_data/$subj/func_2/SR4_run5_SENSE.nii.gz'[0..$]'
3dTcat -prefix $output_dir/pb00.$subj.r06.tcat \
    /home/image030/fMRI_data/$subj/func_2/SR4_run6_SENSE.nii.gz'[0..$]'

# and make note of repetitions (TRs) per run
# 001 -006

 if ( $subj <= '006' ) then 
    set tr_counts = ( 195 178 173 188 186 179 )
 else
    set tr_counts = ( 197 180 175 190 188 182 )
 endif
...
3dDeconvolve -input pb04.$subj.r*.scale+tlrc.HEAD                            \
    ...
    -stim_times_AM2 4 stimuli/rbcue.GLM1.times.F2.txt 'BLOCK(2,1)'           \
    -stim_label 4 GLM1.times.F2                                              \
    -jobs 8                                                                  \
...
1dcat X.nocensor.xmat.1D'[24]' > ideal_times.blueCue.1D
1dcat X.nocensor.xmat.1D'[25]' > ideal_times.redCue.1D
...
#     /home/image030/analysis_code/stimulus_glm/rbcue.times.blueCue.txt       \
#     /home/image030/analysis_code/stimulus_glm/rbcue.times.redCue.txt        \
#     /home/image030/analysis_code/stimulus_glm/rbcue.times.F1.txt            \
#     /home/image030/analysis_code/stimulus_glm/rbcue.GLM1.times.F2.txt       \
#     -regress_stim_labels times.blueCue times.redCue times.F1 GLM1.times.F2  \
#     -regress_basis_multi 'BLOCK(1,1)' 'BLOCK(1,1)' 'BLOCK(2,1)'             \
#     'BLOCK(2,1)' -regress_stim_types times times AM2 AM2                    \
#     -regress_censor_motion 2.0 -regress_motion_per_run -regress_opts_3dD    \
