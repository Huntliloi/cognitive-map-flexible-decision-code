...
set output_dir = /home/medicaldata3/LJData/rbCue.glm5.sincos6A.result/$subj
...
cp /home/image030/analysis_code/stimulus_glm/rbCue.glm/rbcue.times.blueCue.txt  \
    ...
    /home/image030/analysis_code/stimulus_glm/rbCue.glm.sincos6A/rbcue.GLM5.times.F2.txt \
    $output_dir/stimuli
...
3dDeconvolve -input $glm1_rpath/pb04.$subj.r*.scale+tlrc.HEAD                            \
    ...
    -stim_times_AM2 4 stimuli/rbcue.GLM5.times.F2.txt 'BLOCK(2,1)'           \
    -stim_label 4 times.F2.sincos6A                                              \
    -jobs 8                                                                  \
