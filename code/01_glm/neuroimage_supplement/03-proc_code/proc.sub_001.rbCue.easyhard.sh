...
set output_dir = /home/medicaldata3/LJData/rbCue.easyhard.result/$subj
...
3dDeconvolve -input $glm1_rpath/pb04.$subj.r*.scale+tlrc.HEAD                            \
    ...
    -stim_times_AM2 3 stimuli/rbcue.F1.times.easy.txt 'BLOCK(2,1)'           \
    -stim_label 3 times.F1.easy                                               \
    -stim_times_AM2 4 stimuli/rbcue.F1.times.hard.txt 'BLOCK(2,1)'           \
    -stim_label 4 times.F1.hard                                              \
#    -stim_times_AM2 5 stimuli/rbcue.F2.times.easy.txt 'BLOCK(2,1)'            \
#    -stim_label 5 times.F2.easy                                              \
#    -stim_times_AM2 6 stimuli/rbcue.F2.times.hard.txt 'BLOCK(2,1)'           \
