...
set basedir = /home/medicaldata3/LJData/rsa/PPI_ana/rbCue.ppi.result
...
tcsh $scriptdir/cmd.ppi.2.make.regs.rbCue $subj $seed
...
# and run it
tcsh $scriptdir/proc.3dd.ppi.post.full.rbCue $subj $seed $glm1_rpath
