...
set basedir = /home/medicaldata3/LJData/rsa/PPI_ana/wCue.ppi.result
...
set glm1_rpath = /home/medicaldata/LJData/SR_ana/analysis_res/glm_raw/wCue.glm1.result
...
tcsh $scriptdir/cmd.ppi.2.make.regs.wCue $subj $seed
...
# and run it
tcsh $scriptdir/proc.3dd.ppi.post.full.wCue $subj $seed $glm1_rpath
