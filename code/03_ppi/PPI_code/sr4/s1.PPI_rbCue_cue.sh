...
set basedir = /home/medicaldata3/LJData/rsa/PPI_ana/rbCue.ppi.switch.result
...
set maskdir = /home/medicaldata/LJData/SR_ana/analysis_res/rois/SR4_rbcue_ROI
...
tcsh $scriptdir/cmd.ppi.2.make.regs.rbCue_cue $subj $seed
...
# and run it
tcsh $scriptdir/proc.3dd.ppi.post.full.rbCue_cue $subj $seed $glm1_rpath
