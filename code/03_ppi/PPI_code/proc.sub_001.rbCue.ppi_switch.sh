...
set output_dir = /home/medicaldata3/LJData/rsa/PPI_ana/rbCue.ppi.switch.result/$subj
...
cp /home/image030/analysis_code/stimulus_glm/rbCue.ppi/rbCue.ppi.times.switch.txt  \
#    /home/image030/analysis_code/stimulus_glm/rbCue.ppi/rbCue.ppi.times.repeat.txt  \
    $output_dir/stimuli
...
3dDeconvolve -input $glm1_rpath/pb04.$subj.r*.scale+tlrc.HEAD                            \
    ...
    -polort 3 -float                                                         \
    -num_stimts 1                                                            \
    -stim_times 1 stimuli/rbCue.ppi.times.switch.txt 'BLOCK(1,1)'               \
    -stim_label 1 switch                                              \
    -jobs 8                                                                  \
