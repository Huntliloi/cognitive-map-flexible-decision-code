...
set output_dir = /home/medicaldata3/LJData/rsa/PPI_ana/rbCue.ppi.cue.result/$subj
...
cp /home/image030/analysis_code/stimulus_glm/rbCue.ppi/rbCue.ppi.times.red.txt  \
    /home/image030/analysis_code/stimulus_glm/rbCue.ppi/rbCue.ppi.times.blue.txt  \
    $output_dir/stimuli
...
3dDeconvolve -input $glm1_rpath/pb04.$subj.r*.scale+tlrc.HEAD                            \
    ...
    -polort 3 -float                                                         \
    -num_stimts 2                                                            \
    -stim_times 1 stimuli/rbCue.ppi.times.red.txt 'BLOCK(1,1)'               \
    -stim_label 1 red                                              \
    -stim_times 2 stimuli/rbCue.ppi.times.blue.txt 'BLOCK(1,1)'                \
    -stim_label 2 blue                                               \
    -jobs 8                                                                  \
