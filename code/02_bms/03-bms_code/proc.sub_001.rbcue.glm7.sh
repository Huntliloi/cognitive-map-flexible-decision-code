...
# set output_dir = /home/medicaldata/LJData/SR_ana/analysis_res/rbCue.glm4.A.result/$subj
set output_dir = /home/medicaldata/LJData/SR_ana/analysis_res/rbCue.glm7.diag.result/$subj
...
cp   /home/image030/analysis_code/stimulus_glm/rbCue.bms.glm/rbcue.GLM7.times.F2.txt \
    /home/image030/analysis_code/stimulus_glm/rbCue.glm/rbcue.times.blueCue.txt  \
    /home/image030/analysis_code/stimulus_glm/rbCue.glm/rbcue.times.redCue.txt  \
    /home/image030/analysis_code/stimulus_glm/rbCue.glm/rbcue.times.F1.txt      \
    $output_dir/stimuli
...
3dDeconvolve -input $glm1_rpath/pb04.$subj.r*.scale+tlrc.HEAD                            \
    ...
    -stim_times_AM2 4 stimuli/rbcue.GLM7.times.F2.txt 'BLOCK(2,1)'           \
    -stim_label 4 rbcue.diag                                              \
    -jobs 8                                                                  \
