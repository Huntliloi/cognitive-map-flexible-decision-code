...
# set output_dir = /home/medicaldata/LJData/SR_ana/analysis_res/rbCue.glm2.I.result/$subj
set output_dir = /home/medicaldata3/LJData/bms_withoutF1/rbCue.glm2.I.result/$subj
...
cp  /home/image030/analysis_code/stimulus_glm/rbCue.bms.norank/rbcue.GLM2.times.F2.txt \
...
#    /home/image030/analysis_code/stimulus_glm/rbCue.bms.norank/rbcue.times.F1.txt      \
    $output_dir/stimuli
...
#    -stim_times 3 stimuli/rbcue.times.F1.txt 'BLOCK(2,1)'                \
#    -stim_label 3 times.F1                                                   \
    -stim_times_AM2 1 stimuli/rbcue.GLM2.times.F2.txt 'BLOCK(2,1)'           \
    -stim_label 1 rbcue.I                                    \
    -jobs 8                                                                  \
