...
# set output_dir = /home/medicaldata/LJData/SR_ana/analysis_res/rbCue.glm1.D.result/$subj
set output_dir = /home/medicaldata3/LJData/bms_withoutF1/rbCue.glm1.D.result/$subj
...
cp /home/image030/analysis_code/stimulus_glm/rbCue.bms.norank/rbcue.GLM1.times.F2.txt \
...
#    -stim_label 3 times.F1                                                   \
    -stim_times_AM2 1 stimuli/rbcue.GLM1.times.F2.txt 'BLOCK(2,1)'           \
    -stim_label 1 rbcue.D                                    \
    -jobs 8                                                                  \
