...
set output_dir = /home/medicaldata3/LJData/rbCue.glm6.Manhattan.result/$subj
...
cp   /home/image030/analysis_code/stimulus_glm/rbCue.bms.glm/rbcue.GLM6.times.F2.txt \
...
3dDeconvolve -input $glm1_rpath/pb04.$subj.r*.scale+tlrc.HEAD                            \
    ...
    -stim_times_AM2 4 stimuli/rbcue.GLM6.times.F2.txt 'BLOCK(2,1)'           \
    -stim_label 4 rbcue.Manhattan                                              \
    -jobs 8                                                                  \
