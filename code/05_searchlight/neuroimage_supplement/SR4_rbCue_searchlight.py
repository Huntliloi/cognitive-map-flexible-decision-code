...
def rdm_calc(data):
    obs = {
        "cond":
            ['Red_4', 'Red_3', 'Red_2', 'Red_1',
             'Red_8', 'Red_7', 'Red_6', 'Red_5',
             'Red_12', 'Red_11', 'Red_10', 'Red_9',
             'Red_16', 'Red_15', 'Red_14', 'Red_13',
             'Blue_4', 'Blue_3', 'Blue_2', 'Blue_1',
             'Blue_8', 'Blue_7', 'Blue_6', 'Blue_5',
             'Blue_12', 'Blue_11', 'Blue_10', 'Blue_9',
             'Blue_16', 'Blue_15', 'Blue_14', 'Blue_13']
    }
...
if __name__ == "__main__":
    ...
    modelRDMs = np.loadtxt(open(f'/home/medicaldata3/LJData/rsa/rbCue.rsa_seq_F1F2/modelRDM_rbCue_e+orth+diag.csv', "rb"),
                                   delimiter=",")
    ...
    for subj in subj_list:
        data = [nibabel.load(f'/home/medicaldata3/LJData/rsa/rbCue.rsa_seq_F1F2/stats.{subj}_REML.nii').get_fdata().squeeze()[..., 1:96:3]]
    ...
    # 执行searchlight操作并计算kendall系数 broadcast第一行为模型RDM，从第二个数据后为Nperm的结果
        ...
        # niftiNew.to_filename(f'/home/medicaldata3/LJData/rsa/rbCue.rsa_seq_F1F2/regress_mas/tau.orth.{subj}.nii')
